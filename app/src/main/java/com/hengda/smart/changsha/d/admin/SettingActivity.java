...
import com.hengda.smart.changsha.d.model.SettingItem;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 10://工程模式
                        //TODO 工程模式
                        openActivity(SettingActivity.this, ProgramText.class);
                        break;
                    case 11://测试平台
        ...
        DialogCenter.showDialog(SettingActivity.this, new DialogClickListener() {
            ...
            public void p() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        FileUtils.deleteFile(HdConstants.getDefaultFileDir());
