...
public class LoginActivity extends BaseActivity {
    ...
    private void acquireSetPermission() {
        if (TextUtils.equals(pwd, HdAppConfig.getPassword()) || TextUtils.equals(pwd, HdConstants.LOGIN_PWD)) {
    ...
    private void acquirePowerPermission() {
        if (TextUtils.equals(pwd, HdAppConfig.getPassword()) || TextUtils.equals(pwd, HdConstants.LOGIN_PWD)) {
            HdAppConfig.setPowerMode(1);
            Toast.makeText(this, R.string.get_power_perm_success, Toast.LENGTH_SHORT).show();

            finish();
        } else {
            HdAppConfig.setPowerMode(0);
            Toast.makeText(this, R.string.msg_error_pwd, Toast.LENGTH_SHORT).show();
